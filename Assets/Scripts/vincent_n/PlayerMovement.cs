...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (AudioManager.instance != null && (Input.GetAxis("Horizontal") != 0 || Input.GetAxis("Vertical") != 0))
        {
            ...
            AudioManager.instance.SetVolume(AudioManager.instance.m_EngineAudioSource, (Mathf.Abs(m_rigidbody.velocity.normalized.x) + Mathf.Abs(m_rigidbody.velocity.normalized.y)) / 2);
